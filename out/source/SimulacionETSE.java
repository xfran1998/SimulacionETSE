/* autogenerated by Processing revision 1283 on 2022-05-02 */
 ...
 public void drawStaticEnvironment()
{
 ...
 public void printInfo(){
  ...
  float time_woutDraw = time_colisiones+time_estructuras+time_integracion;
  float time_withDraw = time_woutDraw+time_draw_scene;
  _output.println(_simTime + "," + SIM_STEP + "," + 1.0f/_deltaTimeDraw + "," +_system._n + "," + time_woutDraw + "," + time_withDraw);
}
